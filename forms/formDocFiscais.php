            ...
            <article class="card-body">
                ...
                <div class="row ">
                    ...
                    <div class="col-md-8 rightSideCab">
                        <div class="row">
                                ...
                                <div class="form-group form-inline col-md-2">
                                    ...
                                    <input class="form-control col-md-6" type="text" id="numTipoDoc" form="form_docFiscais" name="numTipoDoc" value="<?php 
                                        if(isset($codTipo)){
                                ...
                                <div class="form-group date col-md-3">
                                        ...
                                        <input class="form-control col-md-12" type="date" id="dataDoc" name="dataDoc" style="border:0;float:right;"  form="form_docFiscais"  value="<?php echo date('Y-m-d');?>" >
                                    </div>
                        </div>
                    </div>
                </div>
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="list-group" id="show-list2" style="margin-top:-17px">
                            </div>    
                        </div>
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <button class="btn btn-danger btn-block col-md-2 cancelarTipo " id="cancelarTipo"  onclick="cancelarTipo()" style="float:right;margin-top:0px;">Cancelar</button>
                    </div>
                    </div>
            </article>
        </div>
